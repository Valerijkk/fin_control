# Критерии приёмки практик FinControl

Чек-листы для приёмки выполненных практик. Преподаватель или проверяющий отмечает пункты; практика считается принятой, если выполнены все обязательные критерии.

## Как пользоваться

1. Ученик выполняет практику по инструкции из [docs/practices](../practices/).
