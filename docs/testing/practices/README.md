...
Детальные пошаговые практики лежат в [**docs/practices/**](../../practices/). Здесь — ссылки для перехода из тестовой документации.

Приложение **одно**, запускается **из коробки**. Для проверки Sentry, AppMetrica и Firebase достаточно подставить ключи: **Sentry и AppMetrica** — в [`lib/config/student_env.dart`](../../../lib/config/student_env.dart) (см. [STUDENT_ENV.md](../../STUDENT_ENV.md)); **Firebase** — по инструкциям в соответствующих практиках (конфиги проекта).
