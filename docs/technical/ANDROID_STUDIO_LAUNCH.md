...
Одно приложение FinControl (Flutter) собирается из корня репозитория; структура кода — в `lib/`. Ниже — как открыть проект в Android Studio и запустить на эмуляторе.
