...
Теория и пошаговые инструкции по технологиям. Во всех практиках используется **одно и то же приложение** FinControl (мобильное и при необходимости веб): инвестиционная платформа с курсами валют, обменником и портфелем.

- **Пошагово:** [practices-step-by-step.md](../practices-step-by-step.md) — карта и ссылки на каждую практику.
- **Ключи Sentry/AppMetrica (практики 06–07):** один файл в коде — [STUDENT_ENV.md](../STUDENT_ENV.md) (там ссылка на файл с переменными).
...
4. **Дистрибуция**: 08 (TestFlight), 09 (Android) — сборки.
